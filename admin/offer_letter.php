...
<head>
    <meta charset="UTF-8">
    <title>Offer Letter - <?php echo htmlspecialchars($student['name']); ?></title>
    <style>
        body { font-family: 'Times New Roman', Times, serif; padding: 50px; line-height: 1.6; }
        .letter-container { max-width: 800px; margin: 0 auto; border: 1px solid #ccc; padding: 50px; }
